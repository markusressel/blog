<template>
  <div class="flex flex-wrap">
    ...
    <a href="https://github.com/markusressel" target="_blank" class="flex place-items-center flex-col w-full md:w-48 bg-gray-100 dark:bg-gray-800 rounded-xl p-4 mx-0 my-2 md:mx-4 md:my-4 shadow-lg hover:shadow-xl">
